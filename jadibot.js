...
require('./jadibot.js')
nocache('../jadibot.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))

async function NanoBotzInd() {
	const {  saveCreds, state } = await useMultiFileAuthState(`database/rentbot/${sessionJadibot}`)
